...
Using a mixed-methods approach combining quantitative financial analysis with qualitative stakeholder insights, this research provided a complete view of crisis management in the aviation sector. The analysis covered revenue impacts, cost management strategies, government data utilization and long-term sustainability measures implemented by Lufthansa during one of the most challenging periods in aviation history.`,
  image: "/lufthansa.png",
  ...
  learnings: [
    ...
    "Advanced skills in financial modeling and valuation techniques",
  ...
  features: [
    ...
    "Strategic evaluation of government data utilization and effectiveness",
  ...
  techDetails: {
    ...
    sources: "Primary data from Lufthansa financial reports (2020-2023), industry databases (IATA), government data documentation and structured interviews with industry stakeholders. Secondary sources included academic literature and industry analysis reports.",
